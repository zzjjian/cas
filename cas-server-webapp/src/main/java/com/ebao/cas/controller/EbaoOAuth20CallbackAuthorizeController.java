 ...
 * @since 3.5.0
 */
public final class EbaoOAuth20CallbackAuthorizeController extends AbstractController {

    private final Logger logger = LoggerFactory.getLogger(EbaoOAuth20CallbackAuthorizeController.class);
    
    private final String redirectUrl;
    
    public EbaoOAuth20CallbackAuthorizeController(String redirectUrl){
    ...
    protected ModelAndView handleRequestInternal(final HttpServletRequest request, final HttpServletResponse response)
        ...
        if(callbackUrl == null || "".equals(callbackUrl)){
        	if(redirectUrl!=null && !("".equals(redirectUrl))){
        		...
        		return new ModelAndView("default/ui/sessionTimeout");
        	}
        }
