 ...
 * @since 3.5.0
 */
public final class EbaoOAuth20WrapperController extends BaseOAuthWrapperController implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        callbackAuthorizeController = new EbaoOAuth20CallbackAuthorizeController(redirectUrl);
